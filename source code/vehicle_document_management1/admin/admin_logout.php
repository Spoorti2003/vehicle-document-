...
<div class="topnav">
  <a class="active" href="#home">Home</a>
   ...
   <a href="dl1_user.php">Driving Licence</a>
  <a class="active" href=" i1_user.php">Insurance</a>
  <a href="vd11_user.php">Vehicle Document</a>
...
function showSlides() {
  ...
  setTimeout(showSlides, 2000); // Change image every 2 seconds
	   ...
	   <a href="admin.php"> <button  class="button button 1" name="login">login</button> </a>
...
bus or cab from the employes in a company.</font></h3>
...
<h4> Developed By:Spoorti M Patil</h4><br>
        <h4>      Spoorti B Pasannavar</h4>
